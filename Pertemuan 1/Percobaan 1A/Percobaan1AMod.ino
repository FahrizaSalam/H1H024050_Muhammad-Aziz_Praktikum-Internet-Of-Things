...
void loop() {
  ...
  if (jumlahValid > 0) { // hanya proses rata-rata jika ada sampel yang valid
    ...
    Serial.println("Semua sampel gagal dibaca dari sensor DHT22!"); // jaga-jaga jika semua sampel gagal
  }
}
